...
function LoginContent() {
  ...
  useEffect(() => {
    if (error === 'InvalidCredentials') {
      ...
      setErrorMessage('No account found with this Discord ID. Please register first.');
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow flex items-center justify-center py-12 parallax-bg">
        ...
        <div className="w-full max-w-md relative z-10 p-6 bg-secondary/80 border border-gray-800 rounded-lg shadow-lg backdrop-blur-sm">
          <h1 className="text-2xl font-display font-bold text-primary mb-6 text-center cyberpunk-border">{t?.title || 'Login'}</h1>
          ...
          <div className="mt-6 text-center text-sm text-gray-400">
            ...
            <Link href="/register" className="text-primary hover:text-primary/80 hover:underline transition-colors">{t?.registerLink || 'Register'}</Link>
          </div>
        </div>
      </main>
