...
export default function Checkout({
  ...
  const getCouponDiscount = () => order?.couponDiscount || 0;
  const getFinalTotal = () =>
    order?.total || Math.max(0, getSubtotal() - getCouponDiscount());
              ...
              <div className="flex items-center justify-between mb-8">
                <h1 className="text-3xl md:text-4xl font-display font-bold text-white">
                  <span className="cyberpunk-border inline-block">
                    {t("store.checkout.title", "Checkout")}
                  </span>
                </h1>
                <Link
                  href="/store/cart"
              ...
              {loading ? (
                ...
                <div className="max-w-3xl mx-auto text-center py-12">
                  ...
                  <h2 className="text-2xl text-white mb-2">
                    {t("store.checkout.order_not_found", "Order not found")}
                  </h2>
                  <p className="text-gray-400 mb-6">
                    {t(
                      "store.checkout.order_not_found_message",
                    ...
                    <div className="p-6">
                      <div className="flex justify-between items-center pb-4 border-b border-gray-800 mb-6">
                        ...
                        <span className="text-sm bg-primary/20 text-primary px-2 py-1 rounded">
                          {t("store.checkout.order_number", "Order #")}
                    ...
                    <div className="p-6">
                      ...
                      <div className="mb-6">
                        ...
                        <p className="text-gray-400 text-sm mb-6">
                          {t(
                            "store.checkout.paypal_redirect_message",
                        ...
                        {paymentProcessing && (
                          <div className="text-center mt-4">
                            ...
                            <span className="text-gray-400">
                              {t(
                                "store.checkout.processing_payment",
                                "Processing payment..."
                              )}
                            </span>
                          </div>
                      ...
                      <div className="pt-4 border-t border-gray-800">
                        <p className="text-gray-400 text-sm">
                          {t(
                            "store.checkout.terms_agreement",
                          ...
                          >
                            {t(
                              "store.checkout.terms_of_service",
                              "Terms of Service"
                            )}
                          </Link>{" "}
                          {t("store.checkout.and", "and")}{" "}
                          <Link
                            href="/privacy"
                            className="text-primary hover:underline"
                          >
                            {t(
                              "store.checkout.privacy_policy",
                              "Privacy Policy"
                            )}
                          </Link>
                          .
