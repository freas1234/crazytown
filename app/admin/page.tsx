        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <Card className="lg:col-span-1 bg-secondary/50 border-gray-800 backdrop-blur-sm">
            ...
            <CardContent className="space-y-3">
              <Button
                variant="outline"
                className="w-full justify-start border-blue-500/30 bg-blue-500/10 hover:bg-blue-500/20 text-blue-400 gap-2"
                asChild
              >
              ...
              <Button
                variant="outline"
                className="w-full justify-start border-green-500/30 bg-green-500/10 hover:bg-green-500/20 text-green-400 gap-2"
                asChild
              >
              ...
              <Button
                variant="outline"
                className="w-full justify-start border-amber-500/30 bg-amber-500/10 hover:bg-amber-500/20 text-amber-400 gap-2"
                asChild
              >
              ...
              <Button
                variant="outline"
                className="w-full justify-start border-teal-500/30 bg-teal-500/10 hover:bg-teal-500/20 text-teal-400 gap-2"
                asChild
              >
              ...
              <Button
                variant="outline"
                className="w-full justify-start border-purple-500/30 bg-purple-500/10 hover:bg-purple-500/20 text-purple-400 gap-2"
                asChild
              >
          ...
          <Card className="lg:col-span-2 bg-secondary/50 border-gray-800 backdrop-blur-sm">
            ...
            <CardContent>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <Button
                  asChild
                  className="h-20 flex flex-col items-center justify-center space-y-2 bg-blue-500/10 hover:bg-blue-500/20 border-blue-500/30 text-blue-400"
                >
                  <Link href="/admin/store/products">
                ...
                <Button
                  asChild
                  className="h-20 flex flex-col items-center justify-center space-y-2 bg-green-500/10 hover:bg-green-500/20 border-green-500/30 text-green-400"
                >
                ...
                <Button
                  asChild
                  className="h-20 flex flex-col items-center justify-center space-y-2 bg-orange-500/10 hover:bg-orange-500/20 border-orange-500/30 text-orange-400"
                >
                ...
                <Button
                  asChild
                  className="h-20 flex flex-col items-center justify-center space-y-2 bg-purple-500/10 hover:bg-purple-500/20 border-purple-500/30 text-purple-400"
                >
                ...
                <Button
                  asChild
                  className="h-20 flex flex-col items-center justify-center space-y-2 bg-amber-500/10 hover:bg-amber-500/20 border-amber-500/30 text-amber-400"
                >
                  <Link href="/admin/content/translations">
          ...
          <CardContent className="p-4">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                ...
                <p className="text-xs text-gray-400">
                  Control site maintenance status
                </p>
              </div>
