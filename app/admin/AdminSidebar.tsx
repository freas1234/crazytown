...
export default function AdminSidebar() {
  ...
  const navItems = [
    ...
    },
    {
      ...
      permission: "store.products.view",
    },
    {
      name: "Categories",
      href: "/admin/store/categories",
      icon: <FileCode className="h-5 w-5" />,
      permission: "store.categories.view",
    },
    {
      name: "Coupons",
      href: "/admin/store/coupons",
      icon: <Ticket className="h-5 w-5" />,
      permission: "store.coupons.view",
    },
    {
      name: "Featured Cards",
    ...
    },
    {
      ...
      permission: "content.translations",
    },
    {
      name: "Rules",
      href: "/admin/rules",
    ...
    // Always show dashboard, filter others by permission
